        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DrawType = table.Column<int>(type: "int", nullable: false),
                    MaxEntriesTotal = table.Column<int>(type: "int", nullable: false),
                    MaxEntriesPerUser = table.Column<int>(type: "int", nullable: false),
                    DrawHostId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Draw", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Draw_AspNetUsers_DrawHostId",
                        column: x => x.DrawHostId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuestReferenceCode = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prize_DrawId",
                table: "Prize",
                column: "DrawId");

            migrationBuilder.CreateIndex(
                name: "IX_Winner_EntryId",
                table: "Winner",
                column: "EntryId");
